...
```
python -m eval.run              # all 19 cases, ~$0.15
...
a blocking case — 04, 05, 06, 09, 12, 13, 15, 16, 18 — stops the change. Exit codes
...
contract: 19 cases exist (phase-5 5a adds 17, 18 and 24 to phase-3's
13 and phase-4's 14-16), and every id section 9, section 11 (phase-4)
and phase-5 plan section 11 mark blocking is exactly the set flagged
blocking.
