...
SAFE_EXTRA_KEYS: tuple[str, ...] = (
    ...
    "cards",
    "dropped",
    # Grok access (app/web/mcp.py, app/web/mcp_core.py)
    "grant_id",
    ...
    # key or contents.
    "bytes",
    # Claude connector (app/web/oauth.py, oauth_store.py, mcp_claude.py):
    # ids and outcomes only -- never a token, code, state, handle,
    # cookie or client id.
    "connection_id",
    "request_id",
)
